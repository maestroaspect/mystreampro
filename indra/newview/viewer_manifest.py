...
class Windows_x86_64_Manifest(ViewerManifest):
    ...
    def package_finish(self):
        ...
        tempfile = "mystreampro_setup_tmp.nsi"
        ...
        with self.prefix(dst="Contents"):  # everything goes in Contents
            ...
            with self.prefix(dst="Resources"):
                ...
                with self.prefix(src=icon_path) :
                    self.path("mystreampro_icon.icns")
...
class LinuxManifest(ViewerManifest):
    ...
    def construct(self):
        ...
        self.path("VivoxAUP.txt")
        self.path("LGPL-license.txt")
        self.path("res/mystreampro_icon.png","mystreampro_icon.png")
        ...
        with self.prefix(src=icon_path) :
            self.path("mystreampro_256.png","mystreampro_48.png")
            #with self.prefix(dst="res-sdl") :
            #    self.path("mystreampro_256.bmp","ll_icon.BMP")

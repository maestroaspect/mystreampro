...
#!define MUI_ICON   "%%SOURCE%%\installers\windows\mystreampro_icon_os.ico"
#!define MUI_UNICON "%%SOURCE%%\installers\windows\mystreampro_icon_os.ico"
!define MUI_ICON   "%%SOURCE%%\installers\windows\mystreampro_icon${ICON_SUFFIX}.ico"
!define MUI_UNICON "%%SOURCE%%\installers\windows\mystreampro_icon${ICON_SUFFIX}.ico"
# </FS:Ansariel>
...
!define LINDEN_KEY      "SOFTWARE\MyStreamPro"
...
WriteINIStr		"$SMPROGRAMS\$INSTSHORTCUT\MyStreamPro Create Account.url" \
				"InternetShortcut" "URL" \
				"https://mystreampro.com/firstpage/create-account/"
WriteINIStr		"$SMPROGRAMS\$INSTSHORTCUT\SL Your Account.url" \
				"InternetShortcut" "URL" \
				"https://mystreampro.com/account/"
...
WriteRegStr SHELL_CONTEXT "${MSUNINSTALL_KEY}" "Publisher" "MyStreamPro"
WriteRegStr SHELL_CONTEXT "${MSUNINSTALL_KEY}" "URLInfoAbout" "https://www.mystreampro.com"
WriteRegStr SHELL_CONTEXT "${MSUNINSTALL_KEY}" "URLUpdateInfo" "https://www.mystreampro.com/downloads"
WriteRegStr SHELL_CONTEXT "${MSUNINSTALL_KEY}" "HelpLink" "https://www.mystreampro.com/support"
...
# Delete files in \Users\<User>\AppData\Roaming\MyStreamPro
# Remove all settings files but leave any other .txt files to preserve the chat logs
    RMDir /r "$2\AppData\Roaming\MyStreamPro\logs"
    RMDir /r "$2\AppData\Roaming\MyStreamPro\browser_profile"
    RMDir /r "$2\AppData\Roaming\MyStreamPro\user_settings"
    Delete  "$2\AppData\Roaming\MyStreamPro\*.xml"
    Delete  "$2\AppData\Roaming\MyStreamPro\*.bmp"
    Delete  "$2\AppData\Roaming\MyStreamPro\search_history.txt"
    Delete  "$2\AppData\Roaming\MyStreamPro\plugin_cookies.txt"
    Delete  "$2\AppData\Roaming\MyStreamPro\typed_locations.txt"
# Delete files in \Users\<User>\AppData\Local\MyStreamPro
    ${If} ${ISOPENSIM} == "0"
        ${If} ${IS64BIT} == "0"
            RMDir /r "$2\AppData\Local\MyStreamPro"				#Delete the Havok cache folder
        ${Else}
            RMDir /r "$2\AppData\Local\MyStreamPro_x64"			#Delete the OpenSim cache folder
        ${EndIf}
    ${Else}
        ${If} ${IS64BIT} == "0"
            RMDir /r "$2\AppData\Local\MyStreamProOS"			#Delete the Havok cache folder
        ${Else}
            RMDir /r "$2\AppData\Local\MyStreamProOS_x64"		#Delete the OpenSim cache folder
        ${EndIf}
    ${EndIf}

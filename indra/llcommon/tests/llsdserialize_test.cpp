...
namespace tut
{
    ...
    void TestLLSDSerializeData::doRoundTripTests(const std::string& msg)
    {
        ...
        v =
"MyStreamPro Grid is a 3D virtual world built by AspectSoft, offering a diverse range "
"of content, including World Trade Exhibitions, Virtual Offices & Workspaces,"
"Universities Engagement Hubs, and Museums & Art Exhibitions Showcases.\n"
"\n"
"Upon entering the world, you'll discover a vibrant three-dimensional environment, "
"designed to enhance online collaboration and productivity. In this immersive "
"space, you can walk, sit, travel with vehicles, meet people, and explore the "
"surroundings. The environment fosters seamless collaboration, enabling you to host "
"meetings, attend workshops, share presentations, use voice chat, and work together "
"on projects in real time.\n"
"\n"
"The benefits of 3D worlds like MyStreamPro Grid extend beyond mere functionality. "
"They provide a dynamic and engaging way to connect with others, enabling virtual "
"gatherings and virtual offices that feel more personal and interactive. This setup "
"not only facilitates effective communication and teamwork but also makes the experience "
"enjoyable, enriching the way we interact and collaborate in a digital space.\n"
"\n"
"Unlike other platforms, MyStreamPro Grid doesn't involve buying, selling, or "
"trading with real money. This unique environment focuses on creativity and "
"collaboration without financial transactions.\n"
"\n"
"Welcome to MyStreamPro. We look forward to seeing you in-world!\n"
        ;
